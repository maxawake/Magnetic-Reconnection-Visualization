...
namespace
{
    ...
    public:
        MatrixVectorMultiplyFunctor(
            ...
            : AArray(aArray), BArray(bArray), XArray(xArray), Filter(filter)
        {
        }
    ...
    public:
        ComputeCriteriaFunctor(JacobianArrayType *jacobianArray,
            ...
            : JacobianArray(jacobianArray), AcceptedPointsArray(acceptedPointsArray), Filter(filter)
        {
        }
...
vtkVortexCore::vtkVortexCore()
    : HigherOrderMethod(false), FasterApproximation(false)
{
}
